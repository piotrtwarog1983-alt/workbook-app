                ...
                {isGridLayout ? (
                    ...
                    <div className="relative w-full h-full bg-white">
                      ...
                      <div className="absolute inset-0 flex items-start justify-center px-4" style={{ paddingTop: 'calc(3rem - 5%)', marginTop: '5%' }}>
                        {loadingText ? (
                          ...
                          <div className="text-sm sm:text-base font-sans text-gray-900 text-center bg-gray-50 border-2 border-gray-700 rounded-2xl px-5" style={{ paddingTop: '0.966rem', paddingBottom: '0.966rem', lineHeight: '1.4' }}>
                            {(() => {
                  ...
                  isMobile && currentPage.pageNumber === 8 ? (
                    ...
                    <div className="relative w-full h-full bg-white flex flex-col overflow-y-auto">
                      ...
                      <div className="flex-1 px-4 pb-6 bg-white flex items-end justify-center">
                  ...
                  <div className="relative w-full h-full">
                    ...
                    {content.textPosition === 'top-center' ? (
                      <div
                        ...
                        style={{ top: currentPage.pageNumber === 37 ? '0%' : currentPage.pageNumber === 42 ? '15%' : currentPage.pageNumber === 45 ? '6%' : currentPage.pageNumber === 46 ? '8%' : currentPage.pageNumber === 47 ? '13%' : '15%' }}
                      >
                        {loadingText ? (
                      ...
                      <div 
                        ...
                        style={
                          ...
                          : currentPage.pageNumber === 18 ? { top: '-5%' }
                          : undefined
                        }
                      >
                        {loadingText ? (
                  ...
                  <div className="relative w-full h-full bg-white flex flex-col items-center justify-center">
                    ...
                    <div 
                      ...
                      style={currentPage.pageNumber === 24 ? { marginTop: '-1%' } : undefined}
                    >
                    ...
                    <div className="flex-none flex items-start justify-center gap-4 px-6 md:px-8 lg:px-12 pb-4 w-full" style={{ flex: '1.2', marginTop: currentPage.pageNumber === 24 ? '-8%' : undefined, marginLeft: currentPage.pageNumber === 24 ? '-2%' : undefined }}>
                      <div 
                  ...
                  <div className="relative w-full h-full bg-white flex flex-col items-center overflow-visible">
                    ...
                    {currentPage.pageNumber === 32 ? (
                      <div className="flex-1 flex items-start justify-center w-full px-4 pb-2 pt-2 relative">
                        ...
                        <div className="flex gap-8 w-full max-w-[600px]" style={{ marginTop: currentPage.pageNumber === 32 && isMobile ? '45%' : '30%' }}>
                    ...
                    {content.iconUrl && (
                      ...
                      <div 
                        ...
                        style={{ 
                            ...
                            marginTop: currentPage.pageNumber === 38 ? '5%' : undefined
                        }}
                      >
                          <div 
