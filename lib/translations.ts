...
export const translations = {
  PL: {
    ...
    editor: {
      ...
      feather: 'Przejście',
      focusInside: 'Rozmycie w środku',
      focusOutside: 'Rozmycie na zewnątrz',
      apply: 'Zastosuj',
    },
  },
  ...
  DE: {
    ...
    editor: {
      ...
      feather: 'Übergang',
      focusInside: 'Unschärfe innen',
      focusOutside: 'Unschärfe außen',
      apply: 'Anwenden',
    },
  },
  ...
  EN: {
    ...
    editor: {
      ...
      feather: 'Feather',
      focusInside: 'Blur inside',
      focusOutside: 'Blur outside',
      apply: 'Apply',
    },
  },
} as const
