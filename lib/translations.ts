...
export const translations = {
  PL: {
    ...
    editor: {
      ...
      cropTab: 'Kadruj',
      focus: 'Tekstura',
      focusHint: 'Przeciągnij środek • Krawędź zmienia rozmiar',
      sharpnessStrength: 'Siła wyostrzenia',
      feather: 'Przejście',
      sharpnessInside: 'Wyostrzenie wewnątrz',
      sharpnessOutside: 'Wyostrzenie na zewnątrz',
      apply: 'Zastosuj',
      dodge: 'Światło',
      dodgeHint: 'Przeciągnij środek • Krawędź zmienia rozmiar',
      dodgeStrength: 'Siła rozjaśnienia',
      dodgeInside: 'Rozjaśnienie wewnątrz',
      dodgeOutside: 'Rozjaśnienie na zewnątrz',
    },
  },
  ...
  DE: {
    ...
    editor: {
      ...
      cropTab: 'Zuschneiden',
      focus: 'Textur',
      focusHint: 'Mitte ziehen • Rand ändert Größe',
      sharpnessStrength: 'Schärfestärke',
      feather: 'Übergang',
      sharpnessInside: 'Schärfe innen',
      sharpnessOutside: 'Schärfe außen',
      apply: 'Anwenden',
      dodge: 'Licht',
      dodgeHint: 'Mitte ziehen • Rand ändert Größe',
      dodgeStrength: 'Aufhellstärke',
      dodgeInside: 'Aufhellung innen',
      dodgeOutside: 'Aufhellung außen',
    },
  },
  ...
  EN: {
    ...
    editor: {
      ...
      cropTab: 'Crop',
      focus: 'Texture',
      focusHint: 'Drag center • Edge resizes',
      sharpnessStrength: 'Sharpness strength',
      feather: 'Feather',
      sharpnessInside: 'Sharpen inside',
      sharpnessOutside: 'Sharpen outside',
      apply: 'Apply',
      dodge: 'Light',
      dodgeHint: 'Drag center • Edge resizes',
      dodgeStrength: 'Brightness strength',
      dodgeInside: 'Brighten inside',
      dodgeOutside: 'Brighten outside',
    },
  },
} as const
